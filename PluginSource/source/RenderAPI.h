...
public:
	...
	virtual void EndModifyTexture(void* textureHandle, int textureWidth, int textureHeight, void* upscaledTextureHandle, int upscaledTextureWidth, int upscaledTextureHeigh) = 0;
